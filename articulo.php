						...
						<?}else{?>
							...
							<? }else{ ?>
								<div class="articulo-wrapper">
									...
									<div class="fb-like" data-href="http://charmlife.com.mx/articulo.php?id=<?php echo $articulo->articulo_id; ?>" data-width="450" data-layout="button_count" data-show-faces="true" data-send="true"></div>
									<br/>
